...
router.get('/submissions/me', requireAuth, lessonController.listMyLessonSubmissions)
...
router.post('/:id/submissions/file', requireAuth, lessonController.uploadLessonSubmissionFile)
