      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 items-end">
          <div className="bg-gradient-to-br from-primary to-amber-500 rounded-2xl p-6 md:p-10 text-white">
            <p className="text-4xl md:text-6xl font-extrabold mb-3 md:mb-5 leading-none">100K+</p>
            <p className="font-semibold text-sm md:text-base mb-2">Learners building AI skills</p>
            <p className="text-white/75 text-xs md:text-sm leading-relaxed">
              A growing community using Claude to take on real, future-ready work every day.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-primary to-amber-500 rounded-2xl p-6 md:p-10 text-white">
            <p className="text-4xl md:text-6xl font-extrabold mb-3 md:mb-5 leading-none">4.5/5</p>
