    ...
    <footer className="bg-background border-t border-border py-8 md:py-10 px-4 md:px-10">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-5">
          {/* Instagram */}
          <a href="https://www.instagram.com/appexkz?igsh=b3A3bXVmNDJ0d2ww" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
      ...
      <div className="max-w-5xl mx-auto mt-6 pt-6 border-t border-border text-center">
        <p className="text-xs text-muted-foreground font-body">
          © {new Date().getFullYear()} Appex. All rights reserved.
        </p>
      </div>
    </footer>
  );
